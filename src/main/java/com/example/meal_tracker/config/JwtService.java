...
public class JwtService {
    ...
    // rồi thêm key này vào: application.properties
    // jwt.secret=daylamotcairatdaaaavaaaaaaaabimatnaaaaaaaaaaaaaaaaaa
    //    @Value("${jwt.secret}")     private String SECRET_KEY;
    private static final String SECRET_KEY = "daylamotcairatdaaaavaaaaaaaabimatnaaaaaaaaaaaaaaaaaa";

    // tạo tpken từ UserDetails
